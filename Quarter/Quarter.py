...
weeks = range(1, 14)  # 13 weeks per quarter
...
shifts = {}
a = {}  # Balance variable for weekdays
b = {}  # Balance variable for weekends

for i in workers:
    for w in weeks:
        for d in days:
            for s in shift:
                # declaring our 4 dimensional boolean matrix, 1 if work on week w day d shift s, o Otherwise.
    ...
    for w in weeks:
        for d in days:
            if d == 7:  # If sunday then Monday (1) off
                ...
                # for any day different than sunday.
...
workbook = xlsxwriter.Workbook('QuarterSolution_BalancedWithin.xlsx')

worksheet = workbook.add_worksheet("Quarter")

title = workbook.add_format()
title.set_align('center')
title.set_bold()

worksheet.write(0, 5, "First Quarter of 2021", title)
